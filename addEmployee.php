            ...
            <div class=panel-body>
              <form class="form-horizontal" role=form action="sys/engine/input_emp.php" method="post" enctype="multipart/form-data" id="validate">
                ...
                <div class=form-group>
                  ...
                  <label class="col-lg-2 col-md-2 col-sm-12 control-label">Domain</label>
          ...
          <div class=page-header>
            <h4><small></small></h4>
                ...
                <div class=form-group>
                  ...
                  <div class="col-lg-4 col-md-4">
                    <input class=form-control required placeholder="Basic" name="bsc"> 
                  </div>
                  <label class="col-lg-2 col-md-2 col-sm-12 control-label">Meals/Transport</label>
                  <div class="col-lg-4 col-md-4">
                    <input class=form-control required placeholder="Meals" name="mls"> 
                  </div>                
                </div>
                <!-- End .form-group  -->
                <div class="form-group">
                  ...
                  <div class="col-lg-4 col-md-4">
                    <input class=form-control required placeholder="Jamsostek Number" name="bpjs"> 
                  </div>                 
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
          ...
          <div class=page-header>
            <h4><small></small></h4>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-4 col-md-4">
                    <input class=form-control required placeholder="Full Name" name="spo"> 
                  </div>
                  <label class="col-lg-2 col-md-2 col-sm-12 control-label">Child</label>
                  <div class="col-lg-4 col-md-4">
                    <input class=form-control required placeholder="No of Children" name="noc"> 
                  </div>                  
                </div>
                <!-- End .form-group  -->
                <div class="form-group">
                ...
                <div class=form-group>
                  <label class="col-lg-2 col-md-2 col-sm-12 control-label">ID Employee</label>
                    ...
                    <div class="col-lg-4 col-md-4">
                      <input class="form-control tip" placeholder="id number" name="idem">
                    </div>                    
                </div>
                <!-- End .form-group  -->                                               				
                <div class=form-group>
