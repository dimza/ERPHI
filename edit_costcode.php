<?PHP 
  ...
  require_once(__DIR__.'/sys/db_con/db.php');
    ...
    $cur= mysql_query("select * from cost_code order by id_costcode desc limit 1");
    $cur2 = mysql_fetch_array($cur);
    $cur3 = $cur2['noreg_cost']+'1';
...
<body>
  ...
  $tam= mysql_query("select * from cost_code where id_costcode='$kode'");
        ...
        <div class=col-lg-12>
          ...
          <div class="panel panel-default">
            ...
            <div class=panel-body>
              <form class="form-horizontal" role=form action=sys/engine/ubah_costcode.php method="post" id=validate>
                <div class="form-group">
                  <label class="col-lg-2 col-md-2 col-sm-6 control-label">Costcode</label>
                  ...
                  <div class="col-lg-5 col-md-5">
                    <input class=form-control readonly value="<?PHP echo $data_tam['noreg_cost']; ?>">
                  </div>
                  </div>
                    </div>
                  </div>                  
                ...
                <div class=form-group>
                  ...
                  <div class="col-lg-8 col-md-8">
                    <div class=row>                  
                <div class="col-lg-6 col-md-6">
                  <select class="form-control select2" name="muv">
                    <option value="">SELECT              
                      ...
                      <div class="col-lg-5 col-md-5">
                        <div class=input-group>
                          <input class="form-control datetime-picker2" name="tgl" value="<?PHP echo $data_tam['date_cost']; ?>">
                ...
                <div class=form-group>
                  ...
                  <div class="col-lg-11 col-md-11">
                    <input class=form-control value="<?PHP echo $data_tam['description']; ?>" name="dsc"> 
                  </div>
                  </div>
                    </div>                  
                </div>
                ...
                <div class=form-group>
                  ...
                  <div class="col-lg-8 col-md-8">
                    <div class=row>                   
                  <div class="col-lg-11 col-md-11">
                    <textarea class=form-control rows=4 name="rmk"><?PHP echo $data_tam['remark']; ?></textarea> 
                  </div>
                  </div>
                    </div>                  
                </div>
