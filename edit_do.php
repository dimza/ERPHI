<?PHP 
  ...
  require_once(__DIR__.'/sys/db_con/db.php');
    ...
    $tampil2= mysql_query("select * from delivery_order where id_do='$kd2'");
    $data_tampil2 = mysql_fetch_array($tampil2);

    $dn= $data_tampil2['do_no'];
    $cn= $data_tampil2['company_no'];
    $ct= $data_tampil2['client_no'];

    $cn2= mysql_query("select * from company where id_company='$cn'") or die(mysql_error());
    $cn3= mysql_result($cn2, 0, 'nama_company');
      ...
      <div class=row>
        ...
        <div class=col-lg-12>
          ...
          <div class="panel panel-default">
            <!-- Start .panel -->
            <div class=panel-heading><h4>EDIT DELIVERY ORDER FORM</h4></div>
            <div class=panel-body>
              <form class="form-horizontal group-border hover-stripped" role=form action=sys/engine/input_do.php method="post" enctype="multipart/form-data" id=validate>
                <div class=form-group>
                  <label class="col-lg-2 col-md-2 col-sm-12 control-label">DO No.</label>
                  <div class="col-lg-10 col-md-10">
                    <input class=form-control readonly value="<?PHP echo $dn ?>">
                  </div>
                </div>       
                <!-- End .form-group  -->
                <div class=form-group>
                  ...
                  <div class="col-lg-10 col-md-10">
                    <input class=form-control readonly value="<?PHP echo $cn3 ?>">
                  </div>
                </div>       
                <!-- End .form-group  -->                                
                <div class=form-group>
                  <label class="col-lg-2 col-md-2 col-sm-12 control-label">Quotes No.</label>
                    <div class="col-lg-6 col-md-6">
                      <?PHP $comp= mysql_query("select * from quote where status='11' order by id_quote");
                        ...
                        echo '<option value="'.$data_tampil2['quote_no'].'">'.$data_tampil2['quote_no'].'';
                ...
                <div class=form-group>
                  <label class="col-lg-2 col-md-2 col-sm-12 control-label">Remark</label>
                    <div class="col-lg-10 col-md-10">
                      <textarea class=form-control rows=3 name="remark" placeholder="keterangan tambahan.."><?PHP echo $data_tampil2['remark'] ?></textarea>
                    </div>
                </div>
                <!-- End .form-group  -->       
                <div class=form-group>
