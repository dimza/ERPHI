...
<div id=content>
                ...
                <div class=invoice-header>
                  ...
                  <div class="invoice-logo col-md-12">
                      ...
                      <?PHP     
	                      ...
	                      $tpl= mysql_query("select * from buying where po_out='$qz'");	  
                      ...
                      ?>
                        ...
                        <li><?PHP echo "<button type='button' class='btn btn-default' disabled='disabled'>$qz</button>"; ?></li>
                      </ul>
                    </div>
                  ...
                  <?PHP
                      ...
                      $qs= mysql_query("select * from quote where quote_no='$qo'");
                      $qs2 = mysql_fetch_array($qs); 

                      $qs3 = $qs2['company_no'];       	  
				  
					$tampils= mysql_query("select * from company where kode_company='$qs3'");
                  ...
                  <div class="invoice-to col-md-6">
                    <ul class="list-unstyled text-right">
                      ...
                      <li><?PHP echo $data_tampilz['email_supplier']; ?></li>
                    </ul>
                  </div>
                </div>
                <!-- End .invoice-header -->
  ...
  $counter = 1;
	...
	$items= "select * from buying_list where po_out='$qz' order by id_buying_list ASC limit 100";
	$items2=mysql_query($items) or die(mysql_error());
      ...
      //echo '<td>'.$gs3;        
		...
		if ($sign == "21") {
			...
			echo '<th><a><i class="fa-ok-sign"></i></a>';
				                        
		} else if ($sign == "20") {
				                        
			echo '<th><a href="sys/engine/hapus_buying_list.php?kd='.$items3['id_buying_list'].'&&qs='.$qz.'" onclick=\'return confirm("Anda yakin ingin menghapus?")\'><i class="en-cross3"></i></a> | <i class="fa-ok-sign"></i>';
	...
	?>						
            ...
            <button type=submit class="btn btn-primary"><i class="fa-envelope"></i></button>
                      ...
                      <div class=col-md-3>
                          ...
                          $sum = mysql_query("SELECT sum(sub_price) FROM buying_list WHERE po_out='$qz'") or die(mysql_error());
                        ...
                        <div class="well bn dark-bg mb0"><b>TOTAL HARGA</b> = <?php echo number_format("$thg2",0); ?> 
      ...
      <div class=row>
        ...
        <div class=col-lg-12>
          ...
          <div class="panel panel-default toggle">
            ...
            <div class=panel-body>
              <form class="form-horizontal group-border hover-stripped" role=form action=input_item_pembelian2.php?po=<?PHP echo $qz ?>&&tx=<?PHP echo $pjk ?> method="post">
