            ...
            <div class=panel-body>
              <table class="table display" id=datatable>
                ...
                <tbody>					
                    ...
                    $mu= mysql_query("select * from currency where vis='0' order by idCurrency asc limit 0, 10");
                      ...
                      {							
                        ...
                        echo '<td>'.$mu2['modDate'];
                        // echo '<td>'.$mu2['modUser'];                       
                        echo '<td class="text-center"><a href="editCurrency.php?kd='.$mu2["idCurrency"].'" target="_Blank"><i class="fa-edit"></i></a> | ';                
								        echo '<a href="sys/engine/delCurrency.php?kd='.$mu2["idCurrency"].'&&dt='.$today.'&&pg='.$peg.'&&clt='.$mu2["description"].'&&swch=1" onclick=\'return confirm("Anda yakin ingin menghapus?")\'><i class="fa-trash"></i></a>';								
							        }
					        ?> 					
                <tfoot>
                  <tr>
                    <th><a href=#myModal role=button data-toggle=modal><button type=button class="btn btn-sm btn-primary">ADD CURRENCY</button></a>	
                    <th>
                    <th>
                    <!-- <th> -->
