  ...
  <div class=content-wrapper>
    <div class=row>
      ...
      <div class="col-lg-12 heading">
        <h1 class=page-header><i class=en-megaphone></i><?PHP echo $data_tam['nama_supplier']; ?></h1>
        <!-- Start .bredcrumb -->
        <!-- End .breadcrumb -->
      </div>
      <!-- End .page-header -->
            ...
            <div class="panel-heading white-bg">
       		...
       		<div class=panel-body>
				<div class=form-group>
                  <label class="col-lg-4 col-md-4 control-label">Supplier No</label>
                  <div class="col-lg-6 col-md-6">
                    <p><?PHP echo $data_tam['noreg_supplier']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
                ...
                <div class=form-group>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <p><?PHP echo $data_tam['nama_supplier']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
                ...
                <div class=form-group>
                  ...
                  <div class="col-lg-8 col-md-8">
                    <p><?PHP echo $data_tam['alamat_supplier']; ?>, <?PHP echo $data_tam['kota_supplier']; ?> - <?PHP echo $data_tam['kodepos_supplier']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <p><?PHP echo $data_tam['propinsi_supplier']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <p><?PHP echo $data_tam['negara_supplier']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
                  <label class="col-lg-4 col-md-4 col-sm-12 control-label">Phone Mobile</label>
                  <div class="col-lg-6 col-md-6">
                    <p>-</p>
                  </div>
                </div>
                ...
                <div class=form-group>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <p><?PHP echo $data_tam['telpon_supplier']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <p><?PHP echo $data_tam['fax_supplier']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->                
                <div class=form-group>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <p><?PHP echo $data_tam['email_supplier']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
                ...
                <!-- End .form-group  -->
                <div class=form-group>
                  <label class="col-lg-4 col-md-4 col-sm-12 control-label">Products</label>
                  <div class="col-lg-6 col-md-6">
                    <p><?PHP echo $data_tam['productBrand']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
                  <label class="col-lg-4 col-md-4 col-sm-12 control-label">Tags</label>
                  <div class="col-lg-6 col-md-6">
                    <p><?PHP echo $data_tam['tags']; ?></p>
                  </div>
                </div>
                <!-- End .form-group  -->                                
                <div class=form-group>
                ...
                <div class=form-group>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <a href="list_supplier.php"><button type=button class="btn btn-primary"><li class="im-arrow-left"></li></button></a> <a href="edit_sup.php?kd=<?PHP echo $kode ?>"><button type=button class="btn btn-primary">EDIT</button></a>
                  </div>
                </div>
                <!-- End .form-group  -->
