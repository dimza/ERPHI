        ...
        <div class=col-lg-12>
          ...
          <div class="panel panel-default">
            ...
            <div class=panel-heading>
              <h4>ADD PO-OUT WITHOUT QTS</h4>
            </div>
            <div class=panel-body>
              <form class="form-horizontal" role=form action=sys/engine/input_pembelian2.php enctype="multipart/form-data" method="post" id=validate>
                  ...
                  <label class="col-lg-2 col-md-2 col-sm-12 control-label">Company</label>
                    <div class="col-lg-6 col-md-6">
                      <?PHP $comp= mysql_query("select * from company order by id_company asc limit 0, 10");
                        ...
                        echo '<select class="form-control select2" name="comp" onchange="showPo2(this.value)">';
                    ...
                    <div class="col-lg-4 col-md-4" id="txtHint3"></div>                    
                </div>
                <!-- End .form-group  -->                
                <div class=form-group>
