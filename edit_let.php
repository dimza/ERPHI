      ...
      <div class=row>
        ...
        <div class=col-lg-12>
          ...
          <div class="panel panel-default">
            <!-- Start .panel -->
            <div class=panel-heading><h4>EDIT LETTER FORM</h4></div>
            <div class=panel-body>
              <form class="form-horizontal group-border hover-stripped" role=form action=sys/engine/input_letter.php method="post" enctype="multipart/form-data" id=validate>
...
function showLts(str) {
  ...
  xmlhttp.open("GET","sys/engine/getlts.php?l="+str,true);
  xmlhttp.send();
}
</script>
<!-- Load pace first -->
