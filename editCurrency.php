...
<body>
  ...
  ?>
      ...
      <?PHP
        ...
        $tam= mysql_query("select * from `currency` where idCurrency='$kode'");
        ...
        <div class=col-lg-12>
          ...
          <div class="panel panel-default">
            ...
            <div class=panel-body>
              <form class="form-horizontal" role=form action=sys/engine/updateCurrency.php method="post" id=validate>
                <div class="form-group">
                  <label class="col-lg-2 col-md-2 col-sm-12 control-label">Currency Name</label>
                  <div class="col-lg-4 col-md-4">
                    <input class=form-control required value="<?PHP echo $data_tam['description']; ?>" name="cn"> 
                  </div>
                  <div class="col-lg-2 col-md-2">
                    <input class=form-control readonly value="<?PHP echo $kode ?>" name="cc">
                  </div>                  
                </div>
                <!-- End .form-group  -->
                <div class=form-group>
                  ...
                  <div class="col-lg-2 col-md-2">
                    <input class="form-control tip" value="<?PHP echo $data_tam['symbol']; ?>" name="sym">
              ...
              <div class="col-lg-4 col-md-4">
                <select class="form-control select2" name="ngr">
                  <option value="<?PHP echo $data_tam['negara']; ?>"><?PHP echo $data_tam['nation'] ?>  
