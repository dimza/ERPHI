        ...
        <div class=col-lg-12>
          ...
          <div class="panel panel-default">
            ...
            <div class=panel-body>
              <form class="form-horizontal" role=form action=sys/engine/input_costcode.php method="post" id="validate">
                ...
                <div class=form-group>
                  ...
                  <div class="col-lg-11 col-md-11">
                    <textarea class=form-control rows=4 placeholder="New project bussiness for" name="dsc"></textarea> 
                  </div>
                  </div>
                    </div>                  
                </div>
